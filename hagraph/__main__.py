...
def main():
    ...
    parser.add_argument('-i', '--input-file', help='path to configuration.yaml')
    parser.add_argument('-o', '--output-file', help='graphviz file to write')
    parser.add_argument('-p', '--prog', default=DEFAULT_PROG, help='graphviz program')
    args = vars(parser.parse_args())
    conf = load_yaml_config_file(args.get('input_file'))
